...
final Map<String, Compline> defaultCompline = {
  "saturday": Compline(
    ...
    complinePsalm1Antiphon: "Sur nous, Seigneur, que s’illumine ton visage!.",
    complinePsalm1Antiphon2: "",
    complinePsalm1: "PSALM_4",
    complinePsalm2Antiphon: "Au long des nuits, bénissez le Seigneur ! ",
    complinePsalm2Antiphon2: "",
    complinePsalm2: "PSALM_133",
    complineReadingRef: "Dt 6, 4-8a",
    complineReading:
  ...
  "sunday": Compline(
    ...
    complinePsalm1Antiphon2: "",
    complinePsalm1: "PSALM_90",
    complinePsalm2Antiphon: "",
    complinePsalm2Antiphon2: "",
    complinePsalm2: "",
    complineReadingRef: "Ap 22, 4-5",
    complineReading:
  ...
  "monday": Compline(
    ...
    complinePsalm1: "PSALM_85",
    complinePsalm2Antiphon: "",
    complinePsalm2Antiphon2: "",
    complinePsalm2: "",
    complineReadingRef: "1Th 5, 9b-10",
    complineReading:
  ...
  "tuesday": Compline(
    ...
    complinePsalm1: "PSALM_142",
    complinePsalm2Antiphon: "",
    complinePsalm2Antiphon2: "",
    complinePsalm2: "",
    complineReadingRef: "1P 5, 8-9a",
    complineReading:
  ...
  "wednesday": Compline(
    complineHymns: ["avant-la-fin-de-la-lumiere", "te-lucis-ante-terminum"],
    complinePsalm1Antiphon: "Dieu, ma forteresse et mon abri !",
    complinePsalm1Antiphon2: "Devant moi tu as ouvert un passage.",
    complinePsalm1: "PSALM_30_1",
    complinePsalm2Antiphon: "Près de toi se trouve le pardon.",
    complinePsalm2Antiphon2: "J’espère le Seigneur de toute mon âme.",
    complinePsalm2: "PSALM_129",
  ...
  "thursday": Compline(
    complineHymns: ["en-toi-seigneur", "te-lucis-ante-terminum"],
    complinePsalm1Antiphon: "Garde-moi, mon Dieu, mon refuge est en toi.",
    complinePsalm1Antiphon2: "Ma chair reposera en confiance.",
    complinePsalm1: "PSALM_15",
    complinePsalm2Antiphon: "",
    complinePsalm2Antiphon2: "",
    complinePsalm2: "",
    complineReadingRef: "1Th 5, 23",
    complineReading:
  ...
  "friday": Compline(
    ...
    complinePsalm1Antiphon: "Dans ma nuit, je crie vers toi, Seigneur.",
    complinePsalm1Antiphon2: "Que ma prière parvienne jusqu’à toi.",
    complinePsalm1: "PSALM_87",
    complinePsalm2Antiphon: "",
    complinePsalm2Antiphon2: "",
    complinePsalm2: "",
    complineReadingRef: "Jr 14, 7-9b",
    complineReading:
