...
Map<String, FeastDates> commonFeastsList = {
  ...
  'john_baptist_de_la_salle_priest': FeastDates(month: 4, day: 7, priority: 10),
  ...
  'fidelis_of_sigmaringen_priest': FeastDates(month: 4, day: 24, priority: 12),
  ...
  'athanasius_of_alexandria_bishop': FeastDates(month: 5, day: 2, priority: 10),
  ...
  'mary_magdalene_de_pazzi_virgin': FeastDates(month: 5, day: 25, priority: 12),
  'philip_neri_priest': FeastDates(month: 5, day: 26, priority: 10),
  'augustine_of_canterbury_bishop': FeastDates(month: 5, day: 27, priority: 12),
  ...
  'apollinaris_of_ravenna_bishop': FeastDates(month: 7, day: 20, priority: 12),
  ...
  'pius_francesco_forgione_priest': FeastDates(month: 9, day: 23, priority: 10),
  ...
  'margaret_mary_alacoque_virgin': FeastDates(month: 10, day: 16, priority: 12),
