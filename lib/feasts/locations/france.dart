...
Map<String, FeastDates> franceFeastsList = {
  'genevieve_of_paris_virgin_france':
      FeastDates(month: 1, day: 3, precedence: 12),
  'remigius_of_reims_bishop_france':
      FeastDates(month: 1, day: 15, precedence: 12),
  'our_lady_of_lourdes_france': FeastDates(month: 2, day: 11, precedence: 10),
  'bernadette_soubirous_virgin_france':
      FeastDates(month: 2, day: 18, precedence: 12),
  'louise_de_marillac_religious_france':
      FeastDates(month: 5, day: 9, precedence: 12),
  'ivo_of_kermartin_priest_france':
      FeastDates(month: 5, day: 19, precedence: 12),
  'joan_of_arc_virgin_france': FeastDates(month: 5, day: 30, precedence: 12),
  'pothinus_of_lyon_bishop_blandina_of_lyon_virgin_and_companions_martyrs_france':
      FeastDates(month: 6, day: 2, precedence: 12),
  'clotilde_of_burgundy_france': FeastDates(month: 6, day: 5, precedence: 12),
  'our_lady_of_la_salette_france':
