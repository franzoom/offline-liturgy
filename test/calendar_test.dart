  ...
  group('Liturgical Calendar Logic Tests', () {
    ...
    test('Christmas 2025 (Liturgical Year 2026) check', () {
      ...
      calendar = calendarFill(
          calendar, DateTime(2025, 12, 25), 'france', LiturgyData.empty());
    ...
    test('Ash Wednesday 2025 check', () {
      ...
      calendar = calendarFill(
          calendar, DateTime(2025, 3, 5), 'france', LiturgyData.empty());
    ...
    test('Sunday Precedence in Ordinary Time', () {
      ...
      calendar = calendarFill(
          calendar, DateTime(2025, 2, 9), 'france', LiturgyData.empty());
